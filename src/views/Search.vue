      ...
      <div class="glass-effect rounded-2xl p-6 mb-8">
        <div class="flex items-center justify-between">
          ...
          <div v-if="searchQuery" class="text-right">
            <div class="px-4 py-2 bg-blue-100 text-blue-800 text-sm">
              "{{ searchQuery }}"
            </div>
          </div>
        </div>
            ...
            <div class="flex-1">
              ...
              <div class="flex flex-wrap gap-2 mb-3">
                <span
                  ...
                  :key="tag.id"
                  class="px-2 py-1 bg-blue-100 text-blue-800 text-xs"
                >
                  {{ tag.name }}
                </span>
              </div>
              ...
              >
                <div class="flex items-center gap-4">
                  ...
                  <span
                    ...
                    class="px-2 py-1 bg-gray-100 text-gray-700"
                  >
...
const loadResults = async (page = 1) => {
  try {
    ...
    if (route.query.q) {
      ...
      // 分类搜索
      data = await articleApi.getByCategory(route.query.category, {
        page: page - 1,
        size,
      });
    } else if (route.query.tag) {
      // 标签搜索
      data = await articleApi.getByTag(route.query.tag, {
        page: page - 1,
        size,
      });
    }
