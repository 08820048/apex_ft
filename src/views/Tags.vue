        ...
        >
          <div class="flex flex-wrap gap-3">
            <span
              ...
              :style="`font-size: 1rem; background-color: ${
                tag.color || '#3b82f6'
              }20; color: ${tag.color || '#3b82f6'} !important;`"
            >
              {{ tag.name }}
            </span>
          </div>
...
const TagIcon = {
  template:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M17.63,5.84C17.27,5.33 16.67,5 16,5L5,5.01C3.9,5.01 3,5.9 3,7V17C3,18.1 3.9,18.99 5,18.99L16,19C16.67,19 17.27,18.67 17.63,18.16L22,12L17.63,5.84Z" /></svg>',
};
...
<style scoped>
.tag-item {
  @apply px-4 py-2 text-white font-medium shadow-md;
}
