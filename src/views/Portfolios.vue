    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div v-if="featuredPortfolios.length > 0" class="mb-12">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div
            ...
            :key="portfolio.id"
            class="glass-effect rounded-2xl overflow-hidden card-hover group border-2"
      ...
      <div>
        ...
        >
          ...
          >
            <div class="h-32 bg-gray-600 rounded mb-4"></div>
        ...
        <div
          v-else
          class="glass-effect rounded-2xl p-12 text-center border-2"
          style="border-color: #0751cf"
        >
...
onMounted(async () => {
  try {
    await Promise.all([loadPortfolios(), loadFeaturedPortfolios()]);
  } catch (error) {
